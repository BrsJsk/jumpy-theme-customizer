  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Instantly preview, generate, and copy beautiful color themes for the Jumpy2 VS Code extension. No login required—just customize and copy!"
        />
        <link rel="canonical" href="https://jumpy-theme.joskonic.com/" />
        <meta property="og:title" content="Jumpy Theme Customizer" />
        <meta
          property="og:description"
          content="Instantly preview, generate, and copy beautiful color themes for the Jumpy2 VS Code extension."
        />
